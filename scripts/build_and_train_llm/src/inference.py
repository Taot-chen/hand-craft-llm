...
import torch
from modeling_tinyllm import ModelArgs, Transformer
...
class TextGenerator:
    def __init__(
        ...
        # 初始化分词器
        self.tokenizer = Tokenizer(tokenizer_model=self.tokenizer_model_path)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--prompt", type=str, default="One day, Lily met a")
    args = parser.parse_args()

    generator = TextGenerator()  # 初始化生成器
    samples = generator.sample(start=args.prompt, num_samples=3, max_new_tokens=1024)  # 生成 3 个样本
